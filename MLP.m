...
X = [0 0 ; % Entradas necessárias para que seja efetuado o treinamento.
     0 1 ; % Aqui há os 4 valores que os padrões de entrada podem assu-
     1 0 ; % mir.
     1 1]; 

D = [0 ;   % Saídas Desejadas. Note que a concatenação das matrizes X e
     1 ;   % D resultam na tabela verdade do operador lógico XOR.
     1 ;
     0];
...
disp('Treinamento da MLP para o operador lógico XOR - SEEL 2015');
plot(MSE(1:epoca))
grid on
